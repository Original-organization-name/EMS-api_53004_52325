...
public static class DataSeeder
{
    public static WebApplication Seed(this WebApplication app)
    {
        ...
        using var context = scope.ServiceProvider.GetRequiredService<ContractsDbContext>();
    ...
    private static void SeedPositionDict(ContractsDbContext context)
    {
    ...
    private static void SeedWorkplaceDict(ContractsDbContext context)
    {
    ...
    private static void SeedOccupationCodeDict(ContractsDbContext context)
    {
